...
>
  ...
  >
    <h1 class="text-3xl mb-10 w-full">ENTER YOUR NAME</h1>
    <input
      type="text"
      class="bg-transparent border-0 border-b-2 border-b-red-600 focus:ring-0 focus:border-b-red-600 text-center text-4xl w-full font-bold"
      bind:value={name}
    />
